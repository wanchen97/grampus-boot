...
import com.vdegree.grampus.common.core.utils.convert.EnhancedConversionService;
...
public class ConvertUtil {
	...
	public static <T> T convert(@Nullable Object source, Class<T> targetType) {
		...
		GenericConversionService conversionService = EnhancedConversionService.getInstance();
