...
import com.vdegree.grampus.common.core.utils.beans.BeanDiff;
import com.vdegree.grampus.common.core.utils.beans.EnhancedBeanCopier;
import com.vdegree.grampus.common.core.utils.beans.EnhancedBeanMap;
import com.vdegree.grampus.common.core.utils.beans.BeanProperty;
import com.vdegree.grampus.common.core.utils.convert.EnhancedConverter;
import com.vdegree.grampus.common.core.utils.exception.ServiceException;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	...
	public static <T> T copy(@Nullable Object source, Class sourceClazz, Class<T> targetClazz) {
		...
		EnhancedBeanCopier copier = EnhancedBeanCopier.create(sourceClazz, targetClazz, false);
	 ...
	 * @return T
	 */
	public static <T> List<T> copyList(@Nullable Collection<?> sourceList, Class<T> targetClazz) {
		return copyList(sourceList, (List<T>) null, targetClazz);
	}
	 ...
	 * @return T
	 */
	public static <T> List<T> copyList(@Nullable Collection<?> sourceList, @Nullable List<T> targetList, Class<T> targetClazz) {
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		EnhancedBeanCopier copier = EnhancedBeanCopier.create(sourceClazz, targetClazz, true);
		T to = newInstance(targetClazz);
		copier.copy(source, to, new EnhancedConverter(sourceClazz, targetClazz));
		return to;
	}
	...
	public static Map<String, Object> toMap(@Nullable Object bean) {
		...
		return EnhancedBeanMap.create(bean);
	}
